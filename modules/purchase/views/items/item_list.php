...
<div id="wrapper">
  ...
  <!-- add one commodity list sibar start-->       
    ...
    if (isset($item) && !empty($item->currency)) {
...
<?php if(is_array($currencies) && count($currencies) > 0){ ?>
    <?php echo render_select('currency', $currencies, array('id','name','symbol'), 'currency', $selected_currency, $currency_attr); ?>
<?php } ?>
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    //$attr = ['data-type' => 'currency'];
                                     echo render_input('ex_work_price', 'ex_work_price','', 'number', $attr); ?>
