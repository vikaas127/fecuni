                           ...
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                              <thead>
                                 <tr>
                                    ...
                                    <th align="right"><?php echo 'Recieved Quantity'; ?></th>
                                    <th align="right"><?php echo _l('ex_work_price'); ?></th>
                              ...
                              <tbody class="ui-sortable">
                                 ...
                                 <tr nobr="true" class="sortable">
                                    ...
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['wh_quantity_received']); ?></td>
                                    <td align="right"><?php echo app_format_money($es['ex_work_price'],$base_currency->symbol); ?></td>
