...
function edit_commodity_item(invoker){
  ...
  $('#commodity_list-add-edit').modal('show');
      ...
      $('#commodity_list-add-edit input[name="rate"]').val($(invoker).data('rate'));
            $('#commodity_list-add-edit input[name="ex_work_price"]').val($(invoker).data('ex_work_price'));
      ...
      $('#commodity_list-add-edit select[name="style_id"]').val($(invoker).data('style_id')).change();
            $('#commodity_list-add-edit select[name="currency"]').val($(invoker).data('currency')).change();
  ...
  function new_commodity_item(){
    ...
    $('#commodity_list-add-edit select[name="sheet_type_id"]').val('').change();
      ...
      $('#commodity_list-add-edit input[name="rate"]').val('');
            $('#commodity_list-add-edit input[name="ex_work_price"]').val('');

      $('#commodity_list-add-edit input[name="type_product"]').val('');

      $('#commodity_list-add-edit select[name="style_id"]').val('').change();
            $('#commodity_list-add-edit select[name="currency"]').val('').change();
  ...
  let material_type_id = $('select[name="material_type_id"] option:selected').text().trim();
    let sheet_type_id = $('select[name="sheet_type_id"] option:selected').text().trim();
  ...
  material_type_id = cleanValue(material_type_id);
    sheet_type_id = cleanValue(sheet_type_id);

  color = cleanValue(color);
  finish_type_id = cleanValue(finish_type_id);
  size_id = cleanValue(size_id);

  const description = [material_type_id,  color, finish_type_id,  size_id,  Length,Thickness]
    .filter(Boolean)
    .join(' | ');
...
// Event binding
$('select[name="material_type_id"],select[name="sheet_type_id"],  select[name="color"], select[name="finish_type_id"],  select[name="size_id"], input[name="Thickness"], input[name="Length"]')
