...
?>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
											<?php echo render_input('middle_name','hr_middle_name',$value,'text',$attrs); ?>
										</div>
                           <div class="col-md-4">
...
echo render_date_input('birthday', 'hr_hr_birthday', _d($birthday));?>
    ...
    <label for="departments" class="control-label"><?php echo _l('hr_organizational_chart'); ?></label>
    <select id="departments" name="departments" class="selectpicker" data-width="100%"  data-action-box="true" data-hide-disabled="true" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
		<option value=""></option> 
        ...
        ?>
            <option value="<?php echo new_html_entity_decode($department['departmentid']); ?>" <?php echo $selected; ?>>
                     ...
                     echo render_input('Personal_tax_code', 'hr_Personal_tax_code', $Personal_tax_code, 'text');?>
                                          ...
                                          <div class="row">
											<div class="col-md-6">
												...
												echo render_input('father_name','hr_father',$father_name,'text'); ?> 
											</div>
												<div class="col-md-6">
												<?php
												$mother_name = (isset($member) ? $member->mother_name : '');
												echo render_input('mother_name','hr_mother',$mother_name,'text'); ?> 
											</div>
											<div class="col-md-6">
												<?php
												$ho_wo_name = (isset($member) ? $member->ho_wo_name : '');
												echo render_input('ho_wo_name','hr_husband_wife',$ho_wo_name,'text'); ?> 
											</div>
												<div class="col-md-6">
                      ...
                      <div class="form-group">
                          <label for="disability_type" class="control-label">Select Disability Type:</label>
                          <select name="disability_type" class="selectpicker" id="disability_type"
                              data-width="100%" data-action-box="true" data-hide-disabled="true"
                              data-live-search="true" data-none-selected-text="-- Select Disability --">
                              <?php foreach ($disability_types as $key => $value) { ?>
                                  <option value="<?php echo htmlspecialchars($key); ?>"
                <?php
                    $selected = '';
                    if (isset($member) && $member->disability_type == $key) {
                        $selected = 'selected';
                    } elseif (!isset($member) && $key == 'none') {
                        $selected = 'selected'; // default to "None" if adding
                    }
                    echo $selected;
                ?>>
