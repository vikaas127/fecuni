						...
						<div class="_buttons">
							<?php if (is_admin() || has_permission('hrm_hr_records','','create') || has_permission('hrm_hr_records','','edit')) { ?>
								...
								<a href="<?php echo admin_url('hr_profile/importxlsx'); ?>" class="btn mright5 btn-info pull-left  ">
									...
									<?php if (has_permission('hrm_reception_staff', '', 'view') || has_permission('hrm_reception_staff', '', 'view_own')): ?>
    <a href="<?php echo admin_url('hr_profile/reception_staff'); ?>" class="btn mright5 btn-info pull-left display-block">
        <?php echo _l('hr_receiving_staff_lable'); ?>
    </a>
<?php endif; ?>
								<?php if (has_permission('hrm_contract', '', 'view') || has_permission('hrm_contract', '', 'view_own')): ?>
    <a href="<?php echo admin_url('hr_profile/contracts'); ?>" class="btn mright5 btn-info pull-left display-block">
        <?php echo _l('hr_hr_contracts'); ?>
    </a>
<?php endif; ?>

<?php if (has_permission('staffmanage_orgchart', '', 'view') || has_permission('staffmanage_orgchart', '', 'view_own')): ?>
    <a href="<?php echo admin_url('hr_profile/organizational_chart'); ?>" class="btn mright5 btn-info pull-left display-block">
        <?php echo _l('hr_organizational_chart'); ?>
    </a>
<?php endif; ?>
<?php if (has_permission('hrm_dependent_person', '', 'view') || has_permission('hrm_dependent_person', '', 'view_own')): ?>
<a href="<?php echo admin_url('hr_profile/dependent_persons'); ?>" class="btn mright5 btn-info pull-left display-block">
    <?php echo _l('hr_dependent_persons'); ?>
</a>
<?php endif; ?>
<?php if (has_permission('staffmanage_job_position', '', 'view') || has_permission('staffmanage_job_position', '', 'view_own')): ?>
    <a href="<?php echo admin_url('hr_profile/job_positions'); ?>" class="btn mright5 btn-info pull-left display-block">
        <?php echo _l('hr_job_descriptions'); ?>
    </a>
<?php endif; ?>
