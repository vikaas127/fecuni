					...
					<ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked">
						...
						foreach($tab as $group_item){
							...
							<a href="<?php echo admin_url('hr_profile/member/'.$staffid.'/'.$group_item); ?>" data-group="<?php echo new_html_entity_decode($group_item); ?>">
								...
								$icon['investments'] = '<span class="fa fa-graduation-cap fa-fw fa-lg"></span>';
								...
								}elseif($group_item == 'investments'){
									echo new_html_entity_decode($icon[$group_item] .' '. _l('hr_investments')); 
...
if($group == 'investments'){
	require('modules/hr_profile/assets/js/hr_record/includes/investments_js.php');
}
