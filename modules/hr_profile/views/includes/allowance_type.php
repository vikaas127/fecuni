				...
				<tr>
					...
					<td>
						<?php if(has_permission('hrm_setting', '', 'edit') || is_admin()){ ?>
							<a href="#" onclick="edit_allowance_type(this,<?php echo new_html_entity_decode($c['type_id']); ?>); return false" data-taxable="<?php echo new_html_entity_decode($c['taxable']); ?>" data-name="<?php echo new_html_entity_decode($c['type_name']); ?>" data-amount="<?php echo app_format_money($c['allowance_val'], ''); ?>" class="btn btn-default btn-icon"><i class="fa-regular fa-pen-to-square"></i></a>
						<?php } ?>
