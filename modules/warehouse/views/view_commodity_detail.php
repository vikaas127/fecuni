                    ...
                    <div class="panel-body">               
                        ...
                        <div class="row">
                            <!--<div class="col-md-12">
                              <div class="col-md-2"> 
                                  <div class="gallery">
                                      <div class="wrapper-masonry">
                                          <div id="masonry" class="masonry-layout columns-1">
                                                  ...
                                                  <?php foreach ($commodity_file as $key => $value) { ?>
                                                      <?php
                                                          ...
                                                          if (file_exists(WAREHOUSE_ITEM_UPLOAD . $value["rel_id"] . '/' . $value["file_name"])) {
                                                              $imgSrc = site_url('modules/warehouse/uploads/item_img/'.$value["rel_id"].'/'.$value["file_name"]);
                                                          } elseif (file_exists('modules/purchase/uploads/item_img/' . $value["rel_id"] . '/' . $value["file_name"])) {
                                                              $imgSrc = site_url('modules/purchase/uploads/item_img/'.$value["rel_id"].'/'.$value["file_name"]);
                                                          } elseif (file_exists('modules/manufacturing/uploads/products/' . $value["rel_id"] . '/' . $value["file_name"])) {
                                                              $imgSrc = site_url('modules/manufacturing/uploads/products/'.$value["rel_id"].'/'.$value["file_name"]);
                                                          } else {
                                                              $imgSrc = site_url('modules/warehouse/uploads/nul_image.jpg');
                                                          }
                                                      ?>
                                                      <a class="images_w_table <?php echo $first ? 'active' : ''; ?>" href="javascript:void(0);">
                                                          <img class="images_w_table side-img" src="<?php echo $imgSrc; ?>" alt="<?php echo new_html_entity_decode($value['file_name']); ?>" data-src="<?php echo $imgSrc; ?>" />
                                                      </a>
                                                      <?php $first = false;  ?>
                                                  <?php } ?>
                                              <?php } else { ?>
                                                  <a class="images_w_table  active" href="javascript:void(0);">
                                                      <img class="images_w_table" src="<?php echo site_url('modules/warehouse/uploads/nul_image.jpg'); ?>" alt="nul_image.jpg" data-src="<?php echo site_url('modules/warehouse/uploads/nul_image.jpg'); ?>" />
                                                  </a>
                                              <?php } ?>
                                          </div>
                                      </div>
                              ...
                              <div class="col-md-4">
                                  <img id="active-image" class="img-fluid images_w_table " src="<?php echo isset($commodity_file) && count($commodity_file) > 0 ? site_url('modules/warehouse/uploads/item_img/'.$commodity_file[0]["rel_id"].'/'.$commodity_file[0]["file_name"]) : site_url('modules/warehouse/uploads/nul_image.jpg'); ?>" alt="Active Image" />
                              </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-7 panel-padding">
                                    <table class="table border table-striped table-margintop">
                                        <tbody>
                                          ...
                                          <tr class="project-overview">
                                              <td class="bold"><?php echo _l('hs_code'); ?></td>
                                              <td><?php echo new_html_entity_decode($commodity_item->hs_code) ; ?></td>
                                          </tr>
                                          <tr class="project-overview">
                                ...
                                <div class=col-md-5>
                                    <div style="margin-left: 30px;">
                                      ...
                                      <div class="col-md-12"> 
                                          <button class="prev-btn pn-btn ">&#10094;</button>
                                          <div class="gallery col-md-12">
                                                <div class="wrapper-masonry">
                                                    <div id="masonry" class="masonry-layout columns-4">
                                                        <?php if(isset($commodity_file) && count($commodity_file) > 0){ ?>
                                                            <?php $first = true;  ?>
                                                            <?php foreach ($commodity_file as $key => $value) { ?>
                                                                <?php
                                          ...
                                          <button class="next-btn pn-btn ">&#10095;</button>
                                ...
                                <table class="table table-striped table-margintop">
                                    <tbody>
                                      ...
                                      <tr class="project-overview">
                                        ...
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('Width'); ?></td>
                                            <td><?php echo ($commodity_item->Width) ; ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('Length'); ?></td>
                                            <td><?php echo ($commodity_item->Length) ; ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('Thickness') ; ?></td>
                                            <td><?php echo ($commodity_item->Thickness) ; ?></td>

                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('Finish'); ?></td>
                                            <td><?php echo ($commodity_item->Finish) ; ?></td>
                                        </tr>
                                ...
                                <?php 
                                      $table_data = array(
                                                      '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="table_commodity_list"><label></label></div>',
                                                        _l('_images'),
                                                        _l('commodity_code'),
                                                        _l('commodity_name') . '<div class="commodity-name-tooltip" style="display:none;"></div>',
                                        ...
                                        foreach($cf as $custom_field) {
                                          ...
                                          render_datatable(
                                            $table_data,'table_commodity_list',
...
<div id="fullscreen-view" class="fullscreen-container">
    <span class="fc-close-btn">&times;</span>
    <button class="fullscreen-prev">&#10094;</button>
    <div class=fs-img-container>
     <img id="fullscreen-image" class="fullscreen-img" src="" alt="Full Screen Image">
...
<script>
 $(document).ready(function(){
    let images = $(".masonry-layout a.images_w_table");
    let visibleCount = 4; 
    let startIndex = 0;
    let currentIndex = 0; 
    ...
    function updateGalleryView() {
        images.hide();
        images.slice(startIndex, startIndex + visibleCount).show();
        updateButtonState();
    }

    function updateButtonState() {
        $(".prev-btn").prop("disabled", startIndex === 0);
        $(".next-btn").prop("disabled", startIndex + visibleCount >= images.length);
    }

    $(".images_w_table").click(function(){
        $(".images_w_table").removeClass("active");
        $(this).addClass("active");
        let imgSrc = $(this).find("img").attr("data-src");
        $("#active-image").attr("src", imgSrc);
    });
    ...
    $("#active-image").click(function(){
        ...
        currentIndex = images.index($(".images_w_table.active"));
        $("#fullscreen-view").fadeIn();
    ...
    $(".fullscreen-next").click(function(){
        if (currentIndex < images.length - 1) {
            currentIndex++;
            let newSrc = $(images[currentIndex]).find("img").attr("data-src");
            $("#fullscreen-image").attr("src", newSrc);
            $(".images_w_table").removeClass("active");
    ...
    function updateFullscreenButtons() {
        $(".fullscreen-prev").prop("disabled", currentIndex === 0);
        $(".fullscreen-next").prop("disabled", currentIndex === images.length - 1);
    }
