<?php init_head(); ?>
<style>
  #table-table_commodity_list td, 
  #table-table_commodity_list th {
      max-width: 180px; 
      white-space: wrap;
      overflow: hidden;
...
.tooltip-inner {
    max-width: 600px !important;  /* Default is 200px */
    width: auto;
    white-space: normal;          /* Allow line breaks and wrap */
}
...
<div class="col-md-3">
  <?php $this->load->view('warehouse/item_include/item_select', [
      'select_name' => 'thickness_filter[]',
      'id_name' => 'thickness_filter',
      'multiple' => true,
      'data_none_selected_text' => 'Select Thickness'
  ]); ?>
</div>
<div class="col-md-3">
  <?php $this->load->view('warehouse/item_include/item_select', [
      'select_name' => 'length_filter[]',
      'id_name' => 'length_filter',
      'multiple' => true,
      'data_none_selected_text' => 'Select Length'
  ]); ?>
</div>
                    ...
                    <!-- view/manage -->            
                     ...
                     <div class="row">
                       <div class="col-md-12">
                        ...
                        <div class="col-md-3">
  <?php echo render_select('color_name_filter[]', $colors, array('color_name', 'color_name'), '', '', [
      'data-none-selected-text' => _l('color'),
      'multiple' => true,
                    ...
                    <div class="col-md-12">
                        ...
                        $table_data = array(
                                          '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="table_commodity_list"><label></label></div>',
                                            ...
                                            _l('bend_type'),
                                            _l('no_of_groove'),
                                            _l('grooving_position'),
                                     
                                            _l('development_length'),
  ...
  <!-- add one commodity list sibar start-->       
    ...
    <div class="modal-dialog ht-dialog-width">
      ...
      <div class="modal-content">
                ...
                <!-- interview process start -->
                  <div role="tabpanel" class="tab-pane active" id="interview_infor">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                                 <?php echo render_select('sheet_type_id',$sheet_type_id,array('sheet_type_id',array('sheet_name')),'sheet'); ?>
                              </div>
                            <div class="col-md-12">
                            <?php echo render_select('profile_type_id',$profile_type_id,array('profile_type_id',array('profile_name')),'Profile'); ?>
                            </div>
                          </div>
                            ...
                            <div class="row">
                                ...
                                <?php echo render_input('sku_code', 'commodity_code', '', 'text', ['readonly' => true]); ?>
                            ...
                            <div class="row">
                              <div class="col-md-3">
                            <?php echo render_select('material_type_id',$material_type_id,array('material_type_id',array('material_name')),'material/grade'); ?>
                            </div>
                   ...
                   <div class="col-md-3">
                            <?php echo render_select('color',$colors,array('color_id',array('color_hex','color_name')),'_color'); ?>
                              ...
                              <div class="col-md-3">
                            <?php echo render_select('finish_type_id',$finish_type_id,array('finish_type_id',array('finish_name')),'finish'); ?>
                            </div>  
                                                              <div class="col-md-3">
                                <div class="form-group  items-wrapper input-group-select">
                                          <label for="size_id">Size</label>

                                    <div class="input-group input-group-select">
                                        <select name="size_id" id="size_id" class="form-control selectpicker ajax-search _select_input_group" data-live-search="true" data-none-selected-text="Select Size">
                                            <option value=""></option>
                                            <?php foreach ($sizes as $size): ?>
                                                <option value="<?= $size['size_type_id']; ?>">
                                        ...
                                        <div class="input-group-btn">
                                               ...
                                               <?php if (has_permission('wh_setting', '', 'create') || is_admin() ) { ?>
                                                  ...
                                                  <a href="#" onclick="open_size_type_from_commodity(); return false;" class="btn btn-default waves-effect waves-light">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                  <?php echo render_input('Length', 'Length'); ?>
                                </div>
                                 <div class="col-md-3">
                                  
                                    
                                    <?php 
                                    echo render_input('Width', 'Width'); ?>



                                </div>
                                <div class="col-md-3">
                                  <?php echo render_input('shape', 'shape'); ?>
                                </div>
                              ...
                              <div class="col-md-3">
                                <?php echo render_select('bend_type', $bend_type, ['id', 'name'], 'bend_type'); ?>
                              </div>

                              <div class="col-md-3">
                                  <?php echo render_input('no_of_groove', 'no_of_groove', '', 'number',['step'=>'1']); ?>
                              </div>

                                <div class="col-md-3">
                                    <?php echo render_input('grooving_position', 'grooving_position'); ?>
                                </div>
                                <div class="col-md-3">
                                    <?php echo render_input('development_length', 'development_length', '', 'number', ['step' => 'any']); ?>
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                  <?php echo render_input('calculated_weight', 'calculated_weight' ); ?>
                              </div>

                                <div class="col-md-6">
                                    <?php echo render_input('actual_weight', 'actual_weight'); ?>
                                </div>
                            ...
                            <div class="row">
                                  <div class="col-md-6">
                                <?php echo render_select('cuttype', $cuttype, ['id', 'name'], 'cuttype'); ?>
                              </div>
                                <div class="col-md-6">
                                <?php echo render_select('finish_side', $finish_side, ['id', 'name'], 'finish_side'); ?>
                              </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <?php echo render_input('hs_code', 'HSN code'); ?>
                                </div>
                            </div>
          ...
          <div class="modal fade" id="sizeTypeModal" tabindex="-1" role="dialog" aria-labelledby="sizeTypeModalLabel">
  <div class="modal-dialog" role="document">
    <?php echo form_open(admin_url('warehouse/add_size_type'), ['id' => 'sizeTypeForm']); ?>
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="sizeTypeModalLabel">Add Size Type</h4>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="size_code" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="size_symbol">Size Symbol</label>
            <input type="text" class="form-control" name="size_symbol">
          </div>
          <div class="form-group form-check">
            <input type="checkbox" class="form-check-input" id="displayCheckbox" name="display" value="1" checked>
