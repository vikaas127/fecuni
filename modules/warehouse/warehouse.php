...
define('ACTIVE_PROPOSAL_OLD_CUSTOMER', true);
...
function warehouse_add_head_components(){
    ...
    if (!(strpos($viewuri, '/admin/warehouse') === false)) {  
echo '<link href="' . base_url('modules/warehouse/assets/css/styles.css') . '?v=' . REVISION . '&t=' . time() . '" rel="stylesheet" type="text/css" />';
        ...
        echo '<link href="' . module_dir_url(WAREHOUSE_MODULE_NAME, 'assets/css/commodity_list.css')  .'?v='.time() . REVISION. '"  rel="stylesheet" type="text/css" />';
    }
