<script>
    ...
    (function($) {
        ...
        var productData = <?php echo isset($product_tab_details) ? json_encode($product_tab_details) : '[]'; ?>;
        console.log("Initializing Product Tab Data:", productData);
        ...
        product_tabs = new Handsontable(hotElement1, {
            ...
            columns: [
                ...
                { data: 'qty_to_consume', type: 'numeric', numericFormat: { pattern: '0,0.00' } },
                { data: 'qty_reserved', type: 'numeric', numericFormat: { pattern: '0,0.00' } },
                { data: 'qty_done', type: 'numeric', numericFormat: { pattern: '0,0.00' } },
                { data: 'available_quantity', type: 'numeric', numericFormat: { pattern: '0,0.00' } },
            ],
            colHeaders: [
                '<?php echo _l('id'); ?>',
        ...
        scrap_tabs = new Handsontable(hotElement2, {
            ...
            columns: [
                ...
                { data: 'estimated_quantity', type: 'numeric', numericFormat: { pattern: '0,0.00' } },
