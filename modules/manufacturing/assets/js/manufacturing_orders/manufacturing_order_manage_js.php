...
<script>
	...
	var InvoiceServerParams={
		...
		"material_filter": "[name='material_filter[]']",
		"finish_filter": "[name='finish_filter[]']",
		"profile_filter": "[name='profile_filter[]']",
		"color_filter": "[name='color_filter[]']",
	...
	$.each(InvoiceServerParams, function(i, obj) {
		$('select' + obj).on('change', function() {  
			...
			console.log("Filter changed:", i, "Selected Values:", selectedValues); 
