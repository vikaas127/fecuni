...
<div id="wrapper">
			...
			<div class="col-md-12">
				<div class="panel_s"> 
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12">
								<h4 class="h4-color no-margin"><i class="fa fa-address-card" aria-hidden="true"></i> <?php echo _l('work_orders'); ?></h4>
							</div>
						</div>
						<hr class="hr-color">
						...
						<div class="row">
								...
								<div class="form-group">
									<select name="manufacturing_order_filter[]" id="manufacturing_order_filter" data-live-search="true" class="selectpicker" multiple="true" data-actions-box="true" data-width="100%" data-none-selected-text="<?php echo _l('manufacturing_order'); ?>">
										<?php foreach($manufacturing_orders as $manufacturing_order) { ?>
											<option value="<?php echo new_html_entity_decode($manufacturing_order['id']); ?>"><?php echo new_html_entity_decode($manufacturing_order['manufacturing_order_code']); ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
							...
							<div class="col-md-4 leads-filter-column">
								<div class="form-group">
									...
									<select name="customer_filter[]" id="customer_filter" data-live-search="true" class="selectpicker" multiple="true" data-actions-box="true" data-width="100%" data-none-selected-text="<?php echo _l('customer_label'); ?>">
										<?php foreach($customers as $customer) { ?>
											<option value="<?php echo new_html_entity_decode($customer['userid']); ?>">
												<?php echo new_html_entity_decode($customer['company']); ?>
											</option>
										<?php } ?>
									</select>
								</div>
							...
							<div class="col-md-4">
								<div class="form-group">
									<select name="material_filter[]" class="selectpicker" multiple data-width="100%" data-none-selected-text="<?php echo _l('Material'); ?>">
  ...
  <?php endforeach; ?>
							...
							<div class="col-md-4">
								<div class="form-group">
									<select name="profile_filter[]" class="selectpicker" multiple data-width="100%" data-none-selected-text="<?php echo _l('Profile'); ?>">
  ...
  <?php endforeach; ?>
							...
							<div class="col-md-4">
								<div class="form-group">
									<select name="finish_filter[]" class="selectpicker" multiple data-width="100%" data-none-selected-text="<?php echo _l('Finish'); ?>">
  <?php foreach($finishes as $finish): ?>
    <option value="<?= $finish['value']; ?>"><?= $finish['label']; ?></option>
  <?php endforeach; ?>
</select>
						...
						<div class="col-md-4">
							<div class="form-group">
								<select name="color_filter[]" class="selectpicker" multiple data-width="100%" data-none-selected-text="<?php echo _l('Color'); ?>">
  ...
  <?php endforeach; ?>
								...
								<div class="col-md-4">
							<div class="form-group">
								<select name="thickness_filter[]" class="selectpicker" multiple data-width="100%" data-none-selected-text="<?php echo _l('thickness'); ?>">
  <?php foreach($thicknesses as $thickness): ?>
    <option value="<?= $thickness['value']; ?>"><?= $thickness['label']; ?></option>
  <?php endforeach; ?>
</select>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<?php if(has_permission('manufacturing','','delete')&&has_permission('work_order', '', 'delete') || is_admin()){ ?>
