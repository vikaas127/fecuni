					...
					<div class="panel-body">
						...
						<div class="modal-body">
							<div class="tab-content">
								...
								<div class="row">
									<div class="col-md-3">
  <?php echo render_select('filter_color_id', [], ['color_id', 'color_name'], 'Color', '', [], [], '', '', false); ?>
</div>
<div class="col-md-3">
  <?php echo render_select('profile_type_id', [], ['profile_type_id', 'profile_name'], 'Profile', '', [], [], '', '', false); ?>
</div>

<div class="col-md-2">
  <?php echo render_select('material_type_id', [], ['material_type_id', 'material_name'], 'Material', '', [], [], '', '', false); ?>
</div>

<div class="col-md-2">
  <?php echo render_select('finish_type_id', [], ['finish_type_id', 'finish_name'], 'Finish', '', [], [], '', '', false); ?>
</div>
...
<div class="col-md-2">
  <?php echo render_select('filter_thickness', [], ['thickness', 'thickness'], 'Thickness', '', [], [], '', '', false); ?>
</div>
...
<script>  var allProductList = <?php echo json_encode($products); ?>;
</script>
										</div>
                             ...
                             if ($selected != '') {
                                 ...
                                 echo '<option value="' . $rel_val['id'] . '" selected>' . $rel_val['name'] . '</option>';
									...
									<div class="row">
										...
										<div class="col-md-3">
										<?php echo render_datetime_input('estimate_delivery_date', 'Estimate Delivery Date', $estimate_delivery_date, ['readonly' => true]); ?>
...
<div class="col-md-6">
    <div class="form-group" style="position: relative;">
		...
		<input type="text" name="tolerance" class="form-control" readonly
    value="<?php echo isset($manufacturing_order->tolerance) ? $manufacturing_order->tolerance . '%' : ''; ?>" />
