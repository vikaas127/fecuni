...
<div id="wrapper">
  ...
  <?php endforeach; ?>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<?php if(has_permission('manufacturing','','delete')&&has_permission('manufacturing_orders', '', 'delete') || is_admin()){ ?>
						...
						<?php if (has_permission('manufacturing','','delete')&&has_permission('manufacturing_orders', '', 'delete')) { ?>
