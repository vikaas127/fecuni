...
// Add new client sheet discount
public function add_client_sheet_discount($data)
{
    $insert = [
    ...
    $this->db->insert(db_prefix() . '_sheet_customer_grp_discount', $insert);
    return $this->db->insert_id();
}

// Edit existing client sheet discount
public function edit_client_sheet_discount($data)
{
    $update = [
        'group_id'  => $data['group_id'],
        'sheet_id'  => $data['sheet_id'],
    ...
    return $this->db->update(db_prefix() . '_sheet_customer_grp_discount', $update);
}

// Delete client sheet discount
public function delete_client_sheet_discount($id)
{
    $this->db->where('id', $id);
    return $this->db->delete(db_prefix() . '_sheet_customer_grp_discount');
}
