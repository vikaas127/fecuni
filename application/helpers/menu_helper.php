...
function app_init_admin_sidebar_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_menu_item('PMS', [
        'collapse' => true,
        'name'     => _l('PMS'),
        'position' => 3,
    ...
    $CI->app_menu->add_sidebar_children_item('PMS', [
        'slug'     => 'projects1',
        'name'     => _l('projects'),
    ...
    $CI->app_menu->add_sidebar_menu_item('HRMS', [
        'collapse' => true,
        'name'     => _l('als_HRMS'),
        'position' => 10,
   ...
   if (has_permission('invoice_items', '', 'view') || is_admin()) {
    $CI->app_menu->add_sidebar_children_item('sales', [
        'slug'     => 'quantity_discount',
        'name'     => _l('quantity_discount_setting'),
        'href'     => admin_url('invoice_items/sheet_qty_discount_setting'),
        'position' => 31, // Adjust as needed
        'badge'    => [],
    ]);
}
    ...
    $CI->app_menu->add_sidebar_menu_item('approvals', [
        'collapse' => true,
        'name'     => _l('Approvals'),
        'position' => 15,
        'icon'     => 'fa-solid fa-chart-gantt',
    ...
    if ((staff_can('view',  'estimate_request') || staff_can('view_own',  'estimate_request'))) {
        $CI->app_menu->add_sidebar_children_item('approvals', [
    ...
    if (staff_can('view',  'knowledge_base')) {
        $CI->app_menu->add_setup_menu_item('knowledge-base', [
            'name'     => _l('als_kb'),
    ...
    $CI->app_menu->add_setup_menu_item('Staff & Role', [
        'collapse' => true,
        'name'     => _l('Staff & Role'),
        'position' => 10,
        'badge'    => [],
    ...
    if (staff_can('view',  'staff')) {
        $CI->app_menu->add_setup_children_item('Staff & Role', [
            'name'     => _l('als_staff'),
    ...
    if (is_admin()) {
        ...
        $CI->app_menu->add_setup_children_item('customers', [
            'slug'     => 'customer-sheet-discounts',
            'name'     => _l('customer_sheet_discounts'),
            'href'     => admin_url('clients/sheet_discount'),
            'position' => 6,
            'badge'    => [],
        ]);
    ...
    $CI->app_menu->add_setup_menu_item('Developer', [
        'collapse' => true,
        'name'     => _l('Developer'),
        'position' => 20,
        'badge'    => [],
    ...
    $CI->app_menu->add_setup_menu_item('APP Integration', [
        'collapse' => true,
        'name'     => _l('APP Integration'),
        'position' => 20,
        'badge'    => [],
    ]);
    $modulesNeedsUpgrade = $CI->app_modules->number_of_modules_that_require_database_upgrade();

    $CI->app_menu->add_setup_children_item('APP Integration', [
        'href'     => admin_url('modules'),
        'name'     => _l('modules'),
        'position' => 35,
        'badge'    => [
